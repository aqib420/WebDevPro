...
let orderConfirmation = orderTea("kali chai");
...
let totalCost = calculateTotal(45, 12);
...
// function createTeaMaker(returnFunc) {
//   return returnFunc("green tea");
// }
// let teaMaker = createTeaMaker(teaType);
